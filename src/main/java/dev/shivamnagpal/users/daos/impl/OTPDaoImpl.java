...
public class OTPDaoImpl implements OTPDao {
    ...
    public static final String SELECT_TRIGGERED_OTP = "SELECT * FROM otp where user_id=$1 and email=$2 and valid_after > $3 and purpose = $4 and "
            +
            "otp_status != $5";

    public static final String SELECT_ACTIVE_OTP = "SELECT * FROM otp where user_id=$1 and email=$2 and valid_after > $3 and valid_after <= $4 and "
            +
    ...
    public static final String UPDATE_OTP = "UPDATE otp SET user_id=$1, email=$2, otp_hash=$3, count=$4, valid_after=$5, purpose=$6, "
            +
    ...
    @Override
    public Future<Optional<OTP>> fetchAlreadyTriggeredOTP(
            SqlClient sqlClient,
            Long userId,
            String email,
    ...
    @Override
    public Future<Optional<OTP>> fetchActiveOTP(
            SqlClient sqlClient,
            Long userId,
            String email,
            OTPPurpose otpPurpose
